...
public class InputControl : MonoBehaviour {
    ...
    public static int floorDropSound = 3;
    public static int cartDropSound = 4;
        ...
        for (int i = 0; i < transform.childCount; i++) {
            ...
            if (putDownItem.gameObject.CompareTag ("Grocery")) {
                ...
                if (Vector3.Distance (cart.transform.position, transform.position) < cartRange) {
                    ...
                    putDownItem.gameObject.GetComponent<ItemScript> ().AddSelfToCart ();
    ...
    void TakeItemFromShelf (Collider other) {
        ...
        //caused bugs somehow????
        //item.gameObject.GetComponent<ItemScript> ().itemSoundEffects[0] = soundEffects[floorDropSound];
        //item.gameObject.GetComponent<ItemScript> ().itemSoundEffects[1] = soundEffects[cartDropSound];
    }
